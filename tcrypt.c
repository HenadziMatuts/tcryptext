 ...
 *             
 * alg_test renamed to alg_testext to avoid symbol collision.
 *    Copyright (c) 2018 Henadzi Matuts <eysscreasmake@rambler.ru>
 *
...
int alg_testext(const char *driver, const char *alg, u32 type, u32 mask);
